...
data[0]=int(input("inter maximum marks : "))
data[1]=int(input("enter expected_no_of_words: "))
data[2]=int(input("enter expected_no_of_sentences : "))
...
def get_marks(data, content):
    ...
    # keywords=['data1','mine','database','characterization','knowledge','background','task','classify','associate','visualize','predict','cluster']
